...
insert into sys_user values(2,  105, 'ry',    '若依', '00', 'ry@qq.com',  '15666666666', '1', '', '8e6d98b90472783cc73c17047ddccf36', '222222', '0', '0', '127.0.0.1', now(),now(), 'admin', now(), '', null, '测试员');
...
insert into sys_menu values('4', '若依官网', '0', 4, 'http://classification.vip', 'menuBlank', 'C', '0', '1', '', 'fa fa-location-arrow', 'admin', now(), '', null, '若依官网地址');
-- 二级菜单
...
--积木报表
INSERT INTO sys_menu VALUES('1062','积木报表', 0, 8, '/jmreport/list', 'menuItem', 'C', '0', '1', '', 'fa fa-address-book', 'admin', now(), '', null, '');
...
insert into sys_config values(11, '用户登录-黑名单列表',           'sys.login.blackIPList',            '',              'Y', 'admin', now(), '', null, '设置登录IP黑名单限制，多个匹配项以;分隔，支持匹配（*通配、网段）');
