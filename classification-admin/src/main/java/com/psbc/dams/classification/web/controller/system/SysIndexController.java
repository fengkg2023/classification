...
import com.psbc.dams.classification.common.core.domain.entity.SysMenu;
...
import com.psbc.dams.classification.common.utils.CookieUtils;
...
public class SysIndexController extends BaseController
{
    ...
    public String index(ModelMap mmap)
    {
        ...
        mmap.put("copyrightYear", ClassificationConfig.getCopyrightYear());
        mmap.put("demoEnabled", ClassificationConfig.isDemoEnabled());
    ...
    {
        mmap.put("version", ClassificationConfig.getVersion());
        return "main";
    }
