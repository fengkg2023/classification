...
import com.psbc.dams.classification.common.utils.file.MimeTypeUtils;
...
public class SysProfileController extends BaseController
{
    ...
    public AjaxResult updateAvatar(@RequestParam("avatarfile") MultipartFile file)
    {
        ...
        try
        {
            if (!file.isEmpty())
            {
                String avatar = FileUploadUtils.upload(ClassificationConfig.getAvatarPath(), file, MimeTypeUtils.IMAGE_EXTENSION);
