...
import com.psbc.dams.classification.common.json.JSONObject.JSONArray;
...
public class DemoFormController
{
    ...
    {
        String[] array = { "classification 1", "classification 2", "classification 3", "classification 4", "classification 5" };
        AjaxResult ajax = new AjaxResult();
